...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public StickyHeaderDecoration(StickyHeader adapter) {
        this(adapter, false);
    }
     ...
     *         the sticky header adapter to use
     */
    public StickyHeaderDecoration(StickyHeader adapter, boolean renderInline) {
        stickyHeader = adapter;
    ...
    private boolean hasHeader(int position) {
        ...
        return stickyHeader.getHeaderId(position) != stickyHeader.getHeaderId(previous);
    }
